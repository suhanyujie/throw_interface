...
func (x *GameStartInfo) Reset() {
	*x = GameStartInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_room_model_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GameStartInfo) Descriptor() ([]byte, []int) {
	return file_room_model_proto_rawDescGZIP(), []int{8}
}
...
var file_room_model_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x03, 0x70, 0x6f, 0x73, 0x22, 0x2a, 0x0a, 0x0c, 0x52, 0x6f,
	...
	0x01, 0x28, 0x05, 0x52, 0x01, 0x79, 0x22, 0x4f, 0x0a, 0x0d, 0x47, 0x61, 0x6d, 0x65, 0x53, 0x74,
	...
	0x52, 0x05, 0x72, 0x6f, 0x6c, 0x65, 0x73, 0x42, 0x39, 0x5a, 0x37, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_room_model_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_room_model_proto_goTypes = []interface{}{
	...
	(*GameStartInfo)(nil), // 8: throw.v1.GameStartInfo
	nil,                   // 9: throw.v1.RoleDetailed.AttributesEntry
}
var file_room_model_proto_depIdxs = []int32{
	...
	9, // 6: throw.v1.RoleDetailed.attributes:type_name -> throw.v1.RoleDetailed.AttributesEntry
	7, // 7: throw.v1.RoleState.pos:type_name -> throw.v1.RolePosition
	5, // 8: throw.v1.GameStartInfo.roles:type_name -> throw.v1.RoleDetailed
...
func file_room_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_room_model_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
