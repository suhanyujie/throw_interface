...
type ReqData struct {
	...
	Route string `protobuf:"bytes,1,opt,name=route,proto3" json:"route,omitempty"` // google.protobuf.Struct data = 3;
}
...
type RespData struct {
	...
	Code int32  `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
	Msg  string `protobuf:"bytes,2,opt,name=msg,proto3" json:"msg,omitempty"` // google.protobuf.Struct data = 3;
}
...
var file_throw_proto_rawDesc = []byte{
	...
	0x6c, 0x62, 0x61, 0x63, 0x6b, 0x22, 0x1f, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x44, 0x61, 0x74, 0x61,
	0x12, 0x14, 0x0a, 0x05, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x22, 0x30, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x44, 0x61,
