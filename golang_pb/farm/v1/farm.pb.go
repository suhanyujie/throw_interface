...
var file_farm_proto_msgTypes = make([]protoimpl.MessageInfo, 65)
var file_farm_proto_goTypes = []interface{}{
	...
	nil,                           // 64: throw.v1.SellReward.ChestEntry
	nil,                           // 65: throw.v1.CsTraderSale.ProductsEntry
}
var file_farm_proto_depIdxs = []int32{
	...
	64, // 6: throw.v1.SellReward.chest:type_name -> throw.v1.SellReward.ChestEntry
	...
	65, // 13: throw.v1.CsTraderSale.products:type_name -> throw.v1.CsTraderSale.ProductsEntry
